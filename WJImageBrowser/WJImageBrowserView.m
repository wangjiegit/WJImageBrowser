...
- (void)downLoadImgs {
    for (int i = 0; i < self.urls.count; i++) {
        WJImageBrowserItem *item = _cacheViews[i];
...
@implementation WJImageBrowserItem {
...
- (void)showProgressView {
    [self.progressView removeFromSuperview];
    self.progressView = [[WJSectorProgressView alloc] init];
...
@implementation WJSectorProgressView
